...
@dataclass
class ModelConfig:
    model_file_path = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), 'artifacts','models','model.pkl')

class ModelTrainer:
    def __init__(self):
        self.model_file_path = ModelConfig.model_file_path
    ...
    def initiate_model_trainer(self, X, Y):
        try:
            logging.info("Loading and test input data")
